...
class TestTree: XCTestCase {
    ...
    func testEmpty() {
        XCTAssertTrue(Tree(url, ignore: ignore).items.isEmpty)
    }
    ...
    func testSave() {
        ...
        XCTAssertEqual("84b5f2f96994db6b67f8a0ee508b1ebb8b633c15", Tree(url, ignore: ignore).save(url))
    ...
    func testSaveSub() {
        ...
        XCTAssertEqual("869b9c7ef21df1511a4a1cded69b0b011fe0e8c3", Tree(url, ignore: ignore).save(url))
        let object = try? Data(contentsOf: url.appendingPathComponent(
