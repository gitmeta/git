...
class Spinner: NSView {
    init() {
        ...
        layer?.addSublayer({
            $0.path = {
                $1.addArc(center: CGPoint(x: 35, y: 23), radius: 50, startAngle: 0, endAngle: 2.35619, clockwise: true)
                $0.move(to: $1.currentPoint)
                $1.addArc(center: CGPoint(x: 35, y: 23), radius: 30, startAngle: 0, endAngle: 2.35619, clockwise: true)
                $0.addLine(to: $1.currentPoint)
                return $0
            } (CGMutablePath(), CGMutablePath())
            $0.lineCap = .butt
            $0.add({
                ...
                $0.toValue = {
                    $1.addArc(center: CGPoint(x: 35, y: 23), radius: 50, startAngle: 0, endAngle: 2.35619, clockwise: true)
                    $0.move(to: $1.currentPoint)
                    $1.addArc(center: CGPoint(x: 35, y: 23), radius: 15, startAngle: 0, endAngle: 2.35619, clockwise: true)
                    $0.addLine(to: $1.currentPoint)
                    return $0
                } (CGMutablePath(), CGMutablePath())
                return $0
        ...
        layer?.addSublayer({
            $0.path = {
                $1.addArc(center: CGPoint(x: 35, y: 47), radius: 35, startAngle: 0, endAngle: 2.35619, clockwise: true)
                $0.move(to: $1.currentPoint)
                $1.addArc(center: CGPoint(x: 35, y: 47), radius: 21, startAngle: 0, endAngle: 2.35619, clockwise: true)
                $0.addLine(to: $1.currentPoint)
                return $0
            } (CGMutablePath(), CGMutablePath())
            $0.lineCap = .butt
            $0.add({
                ...
                $0.toValue = {
                    $1.addArc(center: CGPoint(x: 35, y: 47), radius: 35, startAngle: 0, endAngle: 2.35619, clockwise: true)
                    $0.move(to: $1.currentPoint)
                    $1.addArc(center: CGPoint(x: 35, y: 47), radius: 0, startAngle: 0, endAngle: 2.35619, clockwise: true)
                    $0.addLine(to: $1.currentPoint)
                    return $0
                } (CGMutablePath(), CGMutablePath())
                return $0
