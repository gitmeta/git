...
final class Delete: Sheet {
    @discardableResult override init() {
        ...
        label.attributedText = {
            ...
            $0.append(NSAttributedString(string: .local("Delete.subtitle"), attributes: [.font: UIFont.systemFont(ofSize: 12, weight: .light), .foregroundColor: UIColor(white: 1, alpha: 0.9)]))
            return $0
